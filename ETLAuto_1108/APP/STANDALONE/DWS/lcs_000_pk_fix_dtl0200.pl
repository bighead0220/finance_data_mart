...
DELETE FROM dw_sdata.LCS_000_PK_FIX_DTL WHERE etl_dt=DATE('${TX_DATE_YYYYMMDD}');

INSERT  INTO dw_sdata.LCS_000_PK_FIX_DTL(
  ACC ,
  TRAN_DATE ,
  SYS_SEQNO ,
  DTL_SEQNO ,
...
FROM  dw_tdata.LCS_000_PK_FIX_DTL_${TX_DATE_YYYYMMDD}
;
