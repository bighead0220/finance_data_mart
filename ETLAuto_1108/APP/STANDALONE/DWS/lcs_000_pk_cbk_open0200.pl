...
DELETE FROM dw_sdata.LCS_000_PK_CBK_OPEN WHERE etl_dt=DATE('${TX_DATE_YYYYMMDD}');                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
INSERT  INTO dw_sdata.LCS_000_PK_CBK_OPEN(                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
  OP_DATE ,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
  SYS_SEQNO ,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
  OP_INST ,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
  OBK_NO ,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
...
SELECT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
  ...
  COALESCE(OBK_NO, '' ) AS OBK_NO ,
  COALESCE(SUB_ACC, 0 ) AS SUB_ACC ,
  COALESCE(SVT_NO, '' ) AS SVT_NO ,
  COALESCE(C_OP_TYPE, '' ) AS C_OP_TYPE ,
...
FROM  dw_tdata.LCS_000_PK_CBK_OPEN_${TX_DATE_YYYYMMDD}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
