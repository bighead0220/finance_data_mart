...
--Step0:
DELETE FROM dw_sdata.PCS_006_TB_LIN_ORG_MANAGE WHERE start_dt>=DATE('${TX_DATE_YYYYMMDD}');
UPDATE dw_sdata.PCS_006_TB_LIN_ORG_MANAGE SET end_dt=DATE('2100-12-31') WHERE end_dt>=DATE('${TX_DATE_YYYYMMDD}') AND end_dt<>DATE('2100-12-31');

--Step1:
CREATE LOCAL TEMPORARY TABLE  T_334 ON COMMIT PRESERVE ROWS AS SELECT * FROM dw_sdata.PCS_006_TB_LIN_ORG_MANAGE WHERE 1=0;
...
FROM 
 ...
 FROM  dw_tdata.PCS_006_TB_LIN_ORG_MANAGE_${TX_DATE_YYYYMMDD}) N
LEFT JOIN
 (SELECT 
  LINE_ID ,
  CUR_ORG_ID ,
  ...
  DELFLAG ,
  TRUNC_NO 
 FROM dw_sdata.PCS_006_TB_LIN_ORG_MANAGE 
...
--Step3:
UPDATE dw_sdata.PCS_006_TB_LIN_ORG_MANAGE P 
SET End_Dt=DATE('${TX_DATE_YYYYMMDD}')
FROM T_334
WHERE P.End_Dt=DATE('2100-12-31')
AND P.LINE_ID=T_334.LINE_ID
;

--Step4:
INSERT  INTO dw_sdata.PCS_006_TB_LIN_ORG_MANAGE SELECT * FROM T_334;
