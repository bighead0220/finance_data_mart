...
DELETE FROM dw_sdata.LCS_000_PK_FC_FIX_INT WHERE etl_dt=DATE('${TX_DATE_YYYYMMDD}');                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
INSERT  INTO dw_sdata.LCS_000_PK_FC_FIX_INT(                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
  ACC ,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
  N_INT_TYPE ,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
  TRAN_DATE ,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
  CURR_TYPE ,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
...
SELECT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
  COALESCE(ACC, '' ) AS ACC ,
  COALESCE(N_INT_TYPE, 0 ) AS N_INT_TYPE ,
...
FROM  dw_tdata.LCS_000_PK_FC_FIX_INT_${TX_DATE_YYYYMMDD}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
