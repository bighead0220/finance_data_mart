...
--Step0:
DELETE FROM dw_sdata.ECF_001_T01_CUST_EXTEND_INFO WHERE start_dt>=DATE('${TX_DATE_YYYYMMDD}');
UPDATE dw_sdata.ECF_001_T01_CUST_EXTEND_INFO SET end_dt=DATE('2100-12-31') WHERE end_dt>=DATE('${TX_DATE_YYYYMMDD}') AND end_dt<>DATE('2100-12-31');

--Step1:
CREATE LOCAL TEMPORARY TABLE  T_162 ON COMMIT PRESERVE ROWS AS SELECT * FROM dw_sdata.ECF_001_T01_CUST_EXTEND_INFO WHERE 1=0;
...
FROM 
 (SELECT
  ...
  COALESCE(POINT, '' ) AS POINT ,
  COALESCE(WILL_VIP_FLAG, 0 ) AS WILL_VIP_FLAG ,
 ...
 FROM  dw_tdata.ECF_001_T01_CUST_EXTEND_INFO_${TX_DATE_YYYYMMDD}) N
LEFT JOIN
 (SELECT 
  PARTY_ID ,
  EDU_STATE ,
...
--Step3:
UPDATE dw_sdata.ECF_001_T01_CUST_EXTEND_INFO P 
SET End_Dt=DATE('${TX_DATE_YYYYMMDD}')
FROM T_162
WHERE P.End_Dt=DATE('2100-12-31')
AND P.PARTY_ID=T_162.PARTY_ID
;

--Step4:
INSERT  INTO dw_sdata.ECF_001_T01_CUST_EXTEND_INFO SELECT * FROM T_162;
