...
--Step0:
DELETE FROM dw_sdata.ISS_001_GN_LCREJECTRETURNINFO WHERE start_dt>=DATE('${TX_DATE_YYYYMMDD}');
UPDATE dw_sdata.ISS_001_GN_LCREJECTRETURNINFO SET end_dt=DATE('2100-12-31') WHERE end_dt>=DATE('${TX_DATE_YYYYMMDD}') AND end_dt<>DATE('2100-12-31');

--Step1:
CREATE LOCAL TEMPORARY TABLE  T_346 ON COMMIT PRESERVE ROWS AS SELECT * FROM dw_sdata.ISS_001_GN_LCREJECTRETURNINFO WHERE 1=0;
...
FROM 
 (SELECT
  ...
  COALESCE(SENDSWIFT, '' ) AS SENDSWIFT ,
 ...
 FROM  dw_tdata.ISS_001_GN_LCREJECTRETURNINFO_${TX_DATE_YYYYMMDD}) N
LEFT JOIN
 (SELECT 
  TXNSERIALNO ,
  BPNO ,
  ...
  MEMO ,
  LCNO 
 FROM dw_sdata.ISS_001_GN_LCREJECTRETURNINFO 
...
--Step3:
UPDATE dw_sdata.ISS_001_GN_LCREJECTRETURNINFO P 
SET End_Dt=DATE('${TX_DATE_YYYYMMDD}')
FROM T_346
WHERE P.End_Dt=DATE('2100-12-31')
AND P.TXNSERIALNO=T_346.TXNSERIALNO
;

--Step4:
INSERT  INTO dw_sdata.ISS_001_GN_LCREJECTRETURNINFO SELECT * FROM T_346;
