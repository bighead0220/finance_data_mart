...
--Step0:
DELETE FROM dw_sdata.ECF_001_T01_CUST_INFO WHERE start_dt>=DATE('${TX_DATE_YYYYMMDD}');
UPDATE dw_sdata.ECF_001_T01_CUST_INFO SET end_dt=DATE('2100-12-31') WHERE end_dt>=DATE('${TX_DATE_YYYYMMDD}') AND end_dt<>DATE('2100-12-31');

--Step1:
CREATE LOCAL TEMPORARY TABLE  T_163 ON COMMIT PRESERVE ROWS AS SELECT * FROM dw_sdata.ECF_001_T01_CUST_INFO WHERE 1=0;
...
FROM 
 ...
 FROM  dw_tdata.ECF_001_T01_CUST_INFO_${TX_DATE_YYYYMMDD}) N
LEFT JOIN
 (SELECT 
  PARTY_ID ,
  ECIF_CUST_NO ,
...
--Step3:
UPDATE dw_sdata.ECF_001_T01_CUST_INFO P 
SET End_Dt=DATE('${TX_DATE_YYYYMMDD}')
FROM T_163
WHERE P.End_Dt=DATE('2100-12-31')
AND P.PARTY_ID=T_163.PARTY_ID
;

--Step4:
INSERT  INTO dw_sdata.ECF_001_T01_CUST_INFO SELECT * FROM T_163;
