...
DELETE FROM dw_sdata.LCS_000_QRY_CDM_DTL WHERE etl_dt=DATE('${TX_DATE_YYYYMMDD}');                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
INSERT  INTO dw_sdata.LCS_000_QRY_CDM_DTL(                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
  ACC ,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
  TRAN_DATE ,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
  SYS_SEQNO ,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
  DTL_SEQNO ,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
...
SELECT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
  ...
  COALESCE(CSH_TSF_FLAG, 0 ) AS CSH_TSF_FLAG ,
  COALESCE(DR_CR_FLAG, 0 ) AS DR_CR_FLAG ,
  COALESCE(ACCU, 0 ) AS ACCU ,
  COALESCE(RPT_SUM, '' ) AS RPT_SUM ,
  COALESCE(N_TRAN_TYPE, 0 ) AS N_TRAN_TYPE ,
  COALESCE(TIMESTAMP, '' ) AS TIMESTAMP ,
  COALESCE(OPR_TLR, '' ) AS OPR_TLR ,
  COALESCE(B_SUB_TAB_FLAG, 0 ) AS B_SUB_TAB_FLAG ,
  COALESCE(BGN_INT_DATE, 0 ) AS BGN_INT_DATE ,
  DATE('${TX_DATE_YYYYMMDD}')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
FROM  dw_tdata.LCS_000_QRY_CDM_DTL_${TX_DATE_YYYYMMDD}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
